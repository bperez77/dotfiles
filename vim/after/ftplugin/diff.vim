...
"
" Description:
"   This file contains additional settings for the Diff (patch) file type. This file is sourced after the other file
"   type plugin files, so it adds to and/or overwrites the existing settings.
"
"-----------------------------------------------------------------------------------------------------------------------
